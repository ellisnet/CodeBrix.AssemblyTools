================================================================================
README-INDEX: CodeBrix.AssemblyTools
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.AssemblyTools.MitLicenseForever -- read, write and rewrite
      .NET assemblies, IL, metadata and debug symbols (portable PDB,
      native PDB, Mono MDB) from fully managed code.
